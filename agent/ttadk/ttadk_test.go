...
func TestAgent_Name(t *testing.T) {
	a := &Agent{}
	if got := a.Name(); got != "ttadk" {
		t.Errorf("Name() = %q, want %q", got, "ttadk")
	}
}

func TestAgent_CLIBinaryName(t *testing.T) {
	a := &Agent{cliBin: "ttadk"}
	if got := a.CLIBinaryName(); got != "ttadk" {
		t.Errorf("CLIBinaryName() = %q, want %q", got, "ttadk")
	}
...
func TestAgent_CLIDisplayName(t *testing.T) {
	a := &Agent{}
	if got := a.CLIDisplayName(); got != "TTADK" {
		t.Errorf("CLIDisplayName() = %q, want %q", got, "TTADK")
	}
}
